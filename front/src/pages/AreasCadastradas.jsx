...
import { processoService } from "../services/processService";
...
export default function ListagemAreas() {
  ...
  const [processoParaDeletar, setProcessoParaDeletar] = useState({
    id: null,
    nome: "",
    idArea: null,
  });
  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
          ...
          {processosDaArea.length > 0 ? (
            processosDaArea.map((p) => (
              <ArvoreProcessos
                ...
                onDelete={(processosDaArea) =>
                  AbrirConfirmacaoDeletarProcesso(processosDaArea)
                }
              />
            ))
          ) : (
      ...
      <Modal
        ...
        title={
          modoEdicaoProcesso ? "Editar Processo" : "Novo Processo / Subprocesso"
        }
      >
          ...
          <form onSubmit={SalvarProcesso}>
            <div style={{ display: "grid", gap: "10px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormProcesso({ ...formProcesso, nome: e.target.value })
                }
                required
              />
            ...
            <div style={footerButtons}>
              ...
              <button
                type="button"
                onClick={() => setModalProcessoOpen(false)}
                style={btnCancelarStyle}
              >
                Cancelar
              </button>
      ...
      >
        <div style={{ padding: "10px" }}>
          <p style={{ fontSize: "16px", marginBottom: "15px" }}>
            ...
            <strong>{processoParaDeletar?.processo?.nome}</strong>?
          </p>
          ...
          >
            ...
            <p style={{ color: "#c53030", margin: 0, fontSize: "14px" }}>
              Ao excluir este processo,{" "}
              <strong>
                todos os subprocessos vinculados a ele também serão removidos
                permanentemente.
              </strong>
            </p>
          </div>
